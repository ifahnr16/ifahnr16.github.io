        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="ftco-footer-social list-unstyled float-md-center float-lft mt-5" >
              <center>
			  <li class="ftco-animate"><a href="https://www.facebook.com/profile.php?id=100005158127352&locale=id_ID"><span class="icon-facebook" ></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/kelvin.fauzian/"><span class="icon-instagram"></span></a></li>
              <li class="ftco-animate"><a href="http://wa.link/g8s2gs"><span class="icon-whatsapp"></span></a></li>
			  </center>
            </ul>
          </div>
        </div>
